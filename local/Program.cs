...
builder.Services.AddSingleton<CatiaComStaService>();
builder.Services.AddHostedService(static serviceProvider => serviceProvider.GetRequiredService<CatiaComStaService>());
